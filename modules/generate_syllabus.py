...
def generate_syllabus(subject, difficulty, time, goal):    # What does this func. need to generate syllabus?
    """
    This function handles the syllabus generation using input from the user in app.py:
        - get input--> subject of study + difficulty
        - get input--> time committment (hours/week)
        - get input--> what the user is hoping to achieve (goal)
